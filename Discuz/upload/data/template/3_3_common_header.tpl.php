...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1419900520, '3', './data/template/3_3_common_header.tpl.php', './template/comiis_lssy', 'common/header')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1419900520, '3', './data/template/3_3_common_header.tpl.php', './template/comiis_lssy', 'common/header')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1419900520, '3', './data/template/3_3_common_header.tpl.php', './template/comiis_lssy', 'common/header')
;?>
