...
0
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seditor.htm', 1419899287, '3', './data/template/3_3_forum_forumdisplay_fastpost.tpl.php', './template/comiis_lssy', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/forum/seccheck_post.htm', 1419899287, '3', './data/template/3_3_forum_forumdisplay_fastpost.tpl.php', './template/comiis_lssy', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/upload.htm', 1419899287, '3', './data/template/3_3_forum_forumdisplay_fastpost.tpl.php', './template/comiis_lssy', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seccheck.htm', 1419899287, '3', './data/template/3_3_forum_forumdisplay_fastpost.tpl.php', './template/comiis_lssy', 'forum/forumdisplay_fastpost')
;?>
