...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1419857129, '5', './data/template/6_5_common_header_forum_index.tpl.php', './template/comiis_lssy', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1419857129, '5', './data/template/6_5_common_header_forum_index.tpl.php', './template/comiis_lssy', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1419857129, '5', './data/template/6_5_common_header_forum_index.tpl.php', './template/comiis_lssy', 'common/header_forum_index')
;?>
