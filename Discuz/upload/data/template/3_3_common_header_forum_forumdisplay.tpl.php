...
0
|| checktplrefresh('./template/comiis_lssy/common/header.htm', './template/default/common/header_common.htm', 1419899287, '3', './data/template/3_3_common_header_forum_forumdisplay.tpl.php', './template/comiis_lssy', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/comiis_lssy/common/header.htm', './template/default/common/header_qmenu.htm', 1419899287, '3', './data/template/3_3_common_header_forum_forumdisplay.tpl.php', './template/comiis_lssy', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/comiis_lssy/common/header.htm', './template/default/common/pubsearchform.htm', 1419899287, '3', './data/template/3_3_common_header_forum_forumdisplay.tpl.php', './template/comiis_lssy', 'common/header_forum_forumdisplay')
;?>
