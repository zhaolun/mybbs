...
<a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" target="_blank" title="访问我的空间" id="cuser" class="showmenu"  onMouseOver="showMenu({'ctrlid':'cuser','pos':'34!','ctrlclass':'a','duration':2});"><?php echo $_G['member']['username'];?></a>
...
<span class="pipe">|</span><a href="javascript:;" onMouseOver="showMenu({'ctrlid':'cmn','pos':'34!','ctrlclass':'a','duration':2});" id="cmn"><?php echo $comeing_lang['7'];?></a>
<?php } ?>
...
<button type="button" class="comeing_lrg" onclick="window.location.href='member.php?mod=<?php echo $_G['setting']['regname'];?>'" ><em><?php echo $comeing_lang['8'];?></em></button>
