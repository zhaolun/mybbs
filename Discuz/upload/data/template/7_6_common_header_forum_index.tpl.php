...
0
|| checktplrefresh('./template/comeing_city_warm/common/header.htm', './template/default/common/header_common.htm', 1419858519, '6', './data/template/7_6_common_header_forum_index.tpl.php', './template/comeing_city_warm', 'common/header_forum_index')
|| checktplrefresh('./template/comeing_city_warm/common/header.htm', './template/comeing_city_warm/common/pubsearchform.htm', 1419858519, '6', './data/template/7_6_common_header_forum_index.tpl.php', './template/comeing_city_warm', 'common/header_forum_index')
;?>
