...
0
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seditor.htm', 1419858520, '6', './data/template/7_6_forum_forumdisplay_fastpost.tpl.php', './template/comeing_city_warm', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/forum/seccheck_post.htm', 1419858520, '6', './data/template/7_6_forum_forumdisplay_fastpost.tpl.php', './template/comeing_city_warm', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/upload.htm', 1419858520, '6', './data/template/7_6_forum_forumdisplay_fastpost.tpl.php', './template/comeing_city_warm', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seccheck.htm', 1419858520, '6', './data/template/7_6_forum_forumdisplay_fastpost.tpl.php', './template/comeing_city_warm', 'forum/forumdisplay_fastpost')
;?>
