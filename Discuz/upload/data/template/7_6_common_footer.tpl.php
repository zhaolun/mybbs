<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); if(!$comeing_channel['nowp']) { ?>
</div>
...
<div id="ft" class="wp <?php if(!$is_space) { ?>comeing_ft<?php } ?> cl">
    <?php if(!$is_space) { ?>
    <p>
    ...
    <p class="copy">
    Copyright &copy; 2001-2013 <a href="http://www.comsenz.com" target="_blank">Comsenz Inc.</a> &nbsp;<?php echo $Cis['style']['var']['copy'];?> All Rights Reserved.
    </p>
    <p class="copy">Powered by <strong><a href="http://www.discuz.net" target="_blank">Discuz!</a></strong> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } if($_G['setting']['icp']) { ?>( <a href="http://www.miitbeian.gov.cn/" target="_blank"><?php echo $_G['setting']['icp'];?></a> )<?php } ?></p>
    <?php } else { ?>
<div id="flk" class="y">
<p>
