...
0
|| checktplrefresh('./source/plugin/levpop/template/lev.htm', './template/comiis_lssy/common/header.htm', 1419901959, 'levpop', './data/template/3_levpop_lev.tpl.php', './source/plugin/levpop/template', 'lev')
|| checktplrefresh('./source/plugin/levpop/template/lev.htm', './template/comiis_lssy/common/footer.htm', 1419901959, 'levpop', './data/template/3_levpop_lev.tpl.php', './source/plugin/levpop/template', 'lev')
|| checktplrefresh('./source/plugin/levpop/template/lev.htm', './template/default/common/header_common.htm', 1419901959, 'levpop', './data/template/3_levpop_lev.tpl.php', './source/plugin/levpop/template', 'lev')
|| checktplrefresh('./source/plugin/levpop/template/lev.htm', './template/default/common/header_qmenu.htm', 1419901959, 'levpop', './data/template/3_levpop_lev.tpl.php', './source/plugin/levpop/template', 'lev')
|| checktplrefresh('./source/plugin/levpop/template/lev.htm', './template/default/common/pubsearchform.htm', 1419901959, 'levpop', './data/template/3_levpop_lev.tpl.php', './source/plugin/levpop/template', 'lev')
;?>
