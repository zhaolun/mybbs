...
0
|| checktplrefresh('./template/comiis_lssy/common/header.htm', './template/default/common/header_common.htm', 1419899300, '3', './data/template/3_3_common_header_forum_viewthread.tpl.php', './template/comiis_lssy', 'common/header_forum_viewthread')
|| checktplrefresh('./template/comiis_lssy/common/header.htm', './template/default/common/header_qmenu.htm', 1419899300, '3', './data/template/3_3_common_header_forum_viewthread.tpl.php', './template/comiis_lssy', 'common/header_forum_viewthread')
|| checktplrefresh('./template/comiis_lssy/common/header.htm', './template/default/common/pubsearchform.htm', 1419899300, '3', './data/template/3_3_common_header_forum_viewthread.tpl.php', './template/comiis_lssy', 'common/header_forum_viewthread')
;?>
