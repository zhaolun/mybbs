...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1419859496, '7', './data/template/8_7_common_header_forum_index.tpl.php', './template/w3ccool_flatdesign_rdcv', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1419859496, '7', './data/template/8_7_common_header_forum_index.tpl.php', './template/w3ccool_flatdesign_rdcv', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1419859496, '7', './data/template/8_7_common_header_forum_index.tpl.php', './template/w3ccool_flatdesign_rdcv', 'common/header_forum_index')
;?>
