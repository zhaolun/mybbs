...
function sdr() {
    ...
    bet = 0;
    bank = 1e3;
    userInput.addHitArea("mute", butEventHandler, null, {type: "rect", aRect: [455, 0, canvas.width, 75]}, true);
    userInput.addHitArea("help", butEventHandler, null, {type: "rect", aRect: [0, 0, 80, 75]}, true);
    userInput.addHitArea("moregames", butEventHandler, null, {type: "rect", aRect: [canvas.width / 2 - 100, 100, canvas.width / 2 + 100, 150]}, true);
    var e = new Array(canvas.width / 2, 600);
    var t = new Array(canvas.width / 2, 750);
    screens = new Elements.Screens({startImageData: assetLib.getData("titleScreen")}, {moregames: {imageData: assetLib.getData("sgLogo"), pos: t}, play: {imageData: assetLib.getData("playBut"), pos: e}}, canvas.width, canvas.height);
    screens.setRenderFunc("start");
    userInput.addHitArea("startGame", butEventHandler, e, {type: "image", oImageData: assetLib.getData("playBut"), aCentrePos: e});
    userInput.addHitArea("moregames", SG.redirectToPortal, t, {type: "image", oImageData: assetLib.getData("sgLogo"), aCentrePos: t});
    previousTime = (new Date).getTime();
...
function initBetting() {
    ...
    playSound("chipIntro");
    userInput.addHitArea("quitGameBetting", butEventHandler, null, {type: "rect", aRect: [0, 0, 80, 75]}, true);
    userInput.addHitArea("addChip", butEventHandler, {id: 0}, {type: "rect", aRect: [0, 630, 133, 758]});
    userInput.addHitArea("addChip", butEventHandler, {id: 1}, {type: "rect", aRect: [133, 630, 266, 758]});
    userInput.addHitArea("addChip", butEventHandler, {id: 2}, {type: "rect", aRect: [266, 630, 399, 758]});
    userInput.addHitArea("addChip", butEventHandler, {id: 3}, {type: "rect", aRect: [399, 630, 533, 758]});
    userInput.addHitArea("removeChip", butEventHandler, null, {type: "rect", aRect: [170, 390, 360, 530]});
    userInput.addHitArea("deal", butEventHandler, null, {type: "rect", aRect: [390, 390, canvas.width, 530]});
...
function initHelp() {
    gameState = "help";
    userInput.addHitArea("quitHelp", butEventHandler, null, {type: "rect", aRect: [0, 0, 80, 75]}, true);
...
function initDeal() {
    ...
    resetDeck();
    playSound("cardHard");
    userInput.addHitArea("quitGameDealing", butEventHandler, null, {type: "rect", aRect: [0, 0, 80, 75]}, true);
    userInput.addHitArea("hit", butEventHandler, null, {type: "rect", aRect: [266, 630, 399, 758]});
    userInput.addHitArea("stand", butEventHandler, null, {type: "rect", aRect: [399, 630, 533, 758]});
    aPCards2 = new Array;
    ...
    if (aCompCards[0].value == 1 && bank >= bet) {
        userInput.addHitArea("insure", butEventHandler, null, {type: "rect", aRect: [0, 200, 150, 350]});
        e = true
    }
    if (bank >= bet) {
        userInput.addHitArea("double", butEventHandler, null, {type: "rect", aRect: [133, 630, 266, 758]});
        t = true
    }
    panel.setUp("firstDeal", {dealType: dealType, insuranceIsOn: e, value: getBestValue(this.aCurPlayerCards), callback: initBlackjackCompare});
    cards = new Elements.Cards(assetLib.getData("cards"), canvas.width, canvas.height);
    cards.setUp("firstDeal", {aPlayerDealtCards: this.aCurPlayerCards, aCompDealtCards: this.aCompCards, dealType: dealType});
    chips.setUp("firstDeal");
    previousTime = (new Date).getTime();
    buttons = new Elements.Buttons(assetLib.getData("buttons"), canvas.width, canvas.height);
    buttons.setUp("firstDeal", {dealType: dealType, doubleIsOn: t});
    updateDealingEvent()
}
function initBlackjackCompare() {
    var e = getCards(1)[0];
    aCompCards.push(e);
    panel.setUp("compPlay", {value: getBestValue(aCompCards)});
    cards.setUp("compPlay", {oHoleCard: e, callback: checkBlackjack})
}
function initCompPlay() {
    ...
    playSound("cardSoft");
    panel.setUp("compPlay", {value: getBestValue(aCompCards)});
    cards.setUp("compPlay", {oHoleCard: e, callback: checkHands})
}
function dealNewCompCard() {
    var e = getCards(1)[0];
    aCompCards.push(e);
    playSound("cardSoft");
    panel.setUp("newCompCard", {value: getBestValue(aCompCards)});
    cards.setUp("newCompCard", {oNewCard: e, callback: checkHands})
}
function initCompShow() {
    var e = getCards(1)[0];
    aCompCards.push(e);
    playSound("cardSoft");
    cards.setUp("compShow", {oHoleCard: e})
}
function initCompInsuranceShow() {
    aCompCards.push(insuranceCard);
    playSound("cardSoft");
    panel.setUp("compPlay", {value: getBestValue(aCompCards)});
    cards.setUp("compInsuranceShow", {oHoleCard: insuranceCard, callback: checkInsuranceHand})
}
function checkInsuranceHand() {
    ...
    if (e == 21) {
        ...
        userInput.addHitArea("replay", butEventHandler, null, {type: "rect", aRect: [390, 390, canvas.width, 530]})
    } else {
        buttons.canHit = true
    }
}
...
function dealNewPlayerCard(e) {
    ...
    panel.setUp("newPlayerCard", {value: getBestValue(aCurPlayerCards)});
    if (getBestValue(aCurPlayerCards) > 21) {
        if (!splitTaken) {
            if (getBestValue(aPCards1) > 21) {
                console.log("5");
                SG.trigger({type: "gameOver"});
                panel.setUp("bust", {bank: bank});
                if (bank < 5) {
                    bank = 1e3
                }
                buttons.setUp("bust");
                ...
                userInput.removeHitArea("stand");
                userInput.addHitArea("replay", butEventHandler, null, {type: "rect", aRect: [390, 390, canvas.width, 530]});
                cards.setUp("newPlayerCard", {newCard: t, callback: initCompShow})
            } else {
                console.log("6");
                SG.trigger({type: "gameOver"});
                userInput.removeHitArea("split");
            ...
            splitTaken = false;
            cards.setUp("newPlayerCard", {newCard: t});
            panel.setUp("switchHands", {callback: dealNewPlayerCard, event: "bust"});
            bet /= 2;
            numbers.setAmounts(bet, bank);
        ...
        cards.setUp("newPlayerCard", {newCard: t, callback: initCompPlay})
    } else {
        cards.setUp("newPlayerCard", {newCard: t})
    }
}
    ...
    switch (e) {
        ...
        case"split":
            if (buttons.canHit) {
                ...
                cards.setUp("split");
                dealNewPlayerCard();
                panel.setUp("split", {playerHandTotal1: getBestValue(aPCards1), playerHandTotal2: getBestValue(aPCards2)});
                if (insuranceTaken) {
        ...
        case"stand":
            if (buttons.canHit) {
                ...
                if (!splitTaken) {
                    ...
                    splitTaken = false;
                    panel.setUp("switchHands", {callback: dealNewPlayerCard});
                    cards.setUp("switchHands");
                    aCurPlayerCards = aPCards2
                }
                if (insuranceTaken) {
...
function loadPreAssets() {
    if (aLangs.length > 1) {
        preAssetLib = new Utils.AssetLoader(curLang, [
            {id: "langSelect", file: "source/plugin/tyx_blackjack/template/images/langSelect.jpg"},
            {id: "preloadImage", file: "source/plugin/tyx_blackjack/template/images/preloadImage.jpg"}
        ], ctx, canvas.width, canvas.height, false);
        if (curLang == null)preAssetLib.onReady(initLangSelect); else preAssetLib.onReady(loadAssets)
    } else {
        curLang = aLangs[0];
        preAssetLib = new Utils.AssetLoader(curLang, [
            {id: "preloadImage", file: "source/plugin/tyx_blackjack/template/images/preloadImage.jpg"}
...
function initLangSelect() {
    ...
    for (var n = 0; n < aLangs.length; n++) {
        ...
        userInput.addHitArea("langSelect", butEventHandler, {lang: aLangs[n]}, {type: "rect", aRect: [r, i, r + t, i + 140]})
    }
}
...
function loadAssets() {
    assetLib = new Utils.AssetLoader(curLang, [
        {id: "background", file: "source/plugin/tyx_blackjack/template/images/" + curLang + "/background.jpg"},
        {id: "helpScreen", file: "source/plugin/tyx_blackjack/template/images/" + curLang + "/helpScreen.jpg"},
        {id: "titleScreen", file: "source/plugin/tyx_blackjack/template/images/" + curLang + "/titleScreen.jpg"},
        {id: "rotateDeviceMessage", file: "source/plugin/tyx_blackjack/template/images/rotateDeviceMessage.jpg"},
        {id: "splash", file: "source/plugin/tyx_blackjack/template/images/splashScreen.jpg"},
        {id: "playBut", file: "source/plugin/tyx_blackjack/template/images/" + curLang + "/playBut.png"},
		{id: "sgLogo", file: SG.getLogoUrl()},
        {id: "panels", file: "source/plugin/tyx_blackjack/template/images/" + curLang + "/panels_379x159.png", oData: {columns: 4, spriteWidth: 379, spriteHeight: 159}},
        {id: "numbers", file: "source/plugin/tyx_blackjack/template/images/numbers_17x36.png", oData: {columns: 3, spriteWidth: 17, spriteHeight: 36}},
        {id: "cards", file: "source/plugin/tyx_blackjack/template/images/cards_128x173.png", oData: {columns: 9, spriteWidth: 128, spriteHeight: 173}},
        {id: "buttons", file: "source/plugin/tyx_blackjack/template/images/" + curLang + "/buttons_131x133.png", oData: {columns: 4, spriteWidth: 131, spriteHeight: 133}},
        {id: "chips", file: "source/plugin/tyx_blackjack/template/images/chips_133x133.png", oData: {columns: 2, spriteWidth: 133, spriteHeight: 133}}
            ...
            switch (r.type) {
                case"image":
                    if (r.oImageData.isSpriteSheet) {
                        this.aHitAreas.push({id: e, callback: t, oData: n, rect: true, area: [r.aCentrePos[0] - r.oImageData.oData.spriteHeight / 2, r.aCentrePos[1] - r.oImageData.oData.spriteHeight / 2, r.aCentrePos[0] + r.oImageData.oData.spriteWidth / 2, r.aCentrePos[1] + r.oImageData.oData.spriteHeight / 2]})
                    } else {
                        this.aHitAreas.push({id: e, callback: t, oData: n, rect: true, area: [r.aCentrePos[0] - r.oImageData.img.width / 2, r.aCentrePos[1] - r.oImageData.img.height / 2, r.aCentrePos[0] + r.oImageData.img.width / 2, r.aCentrePos[1] + r.oImageData.img.height / 2]})
                    }
                    break;
                case"rect":
                    this.aHitAreas.push({id: e, callback: t, oData: n, rect: true, area: r.aRect});
                    break
            }
        };
...
(function (e) {
    var t = function () {
        function e(e, t, n) {
            ...
            this.canvasHeight = n;
            this.posY = this.canvasHeight;
            TweenLite.to(this, .7, {posY: 0, ease: "Power2.easeOut"})
        }
...
(function (e) {
    var t = function () {
        ...
        e.prototype.setUp = function (e, t) {
            ...
            switch (this.type) {
                case"betting":
                    this.aPanels = new Array({id: 0, posX: this.canvasWidth / 2 - this.oPanelsImgData.oData.spriteWidth / 2, posY: -160}, {id: 7, posX: this.canvasWidth, posY: 385});
                    this.renderFunc = this.renderInGame;
                    TweenLite.to(this.aPanels[0], .5, {posY: -20});
                    break;
                case"firstDeal":
                    this.hideDealBut();
                    this.renderFunc = this.renderInGame;
                    TweenLite.to(this.aPanels[0], .5, {posY: -160, onComplete: this.hideDealTweenComplete, onCompleteParams: [this]});
                    if (t.dealType != "blackjack") {
                        this.insuranceIsOn = t.insuranceIsOn
                    }
                    if (this.insuranceIsOn) {
                        this.aPanels.push({id: 8, posX: -380, posY: 200});
                        TweenLite.to(this.aPanels[this.aPanels.length - 1], .5, {posX: -225, delay: 1})
                    }
                    this.aPanels.push({id: 4, posX: this.canvasWidth, posY: 420});
                    this.playerValuePanel1 = this.aPanels[this.aPanels.length - 1];
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], .5, {posX: 445, delay: 1});
                    this.playerHandTotal1 = t.value;
                    if (dealType == "blackjack") {
                        this.actionCompleteCallback = t.callback;
                        TweenLite.to(this.aPanels[this.aPanels.length - 1], .5, {posX: 445, delay: 1, onComplete: this.blackjackDealComplete, onCompleteParams: [this]})
                    } else {
                        TweenLite.to(this.aPanels[this.aPanels.length - 1], .5, {posX: 445, delay: 1})
                    }
                    break;
                case"newPlayerCard":
                    ...
                    for (var n = 0; n < this.aPanels.length; n++) {
                        if (this.insuranceIsOn && this.aPanels[n].id == 8) {
                            TweenLite.to(this.aPanels[n], .5, {posX: -380})
                        }
                    }
                    break;
                case"newCompCard":
                    ...
                    break;
                case"bust":
                    this.aPanels.push({id: 3, posX: this.canvasWidth / 2 - this.oPanelsImgData.oData.spriteWidth / 2, posY: -160});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], 1, {posY: 213, delay: 1, ease: "Back.easeOut"});
                    this.aPanels.push({id: 9, posX: this.canvasWidth, posY: 385});
                    TweenLite.killTweensOf(this.aPanels[this.aPanels.length - 1]);
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], .3, {posX: 383, delay: 2.3});
                    if (this.handSide == "right") {
                        TweenLite.to(this.playerValuePanel1, .3, {posX: this.canvasWidth, delay: 2})
                    }
                    if (t.bank < 5) {
                        this.aPanels.push({id: 14, posX: this.canvasWidth / 2 - this.oPanelsImgData.oData.spriteWidth / 2, posY: this.canvasHeight});
                        TweenLite.to(this.aPanels[this.aPanels.length - 1], .3, {posY: 600, delay: 2, ease: "Back.easeOut"})
                    }
                    break;
                case"blackjack":
                    this.aPanels.push({id: 1, posX: this.canvasWidth / 2 - this.oPanelsImgData.oData.spriteWidth / 2, posY: -160});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], 1, {posY: 213, delay: 1, ease: "Elastic.easeOut"});
                    this.aPanels.push({id: 9, posX: this.canvasWidth, posY: 385});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], .3, {posX: 383, delay: 2.3});
                    for (var n = 0; n < this.aPanels.length; n++) {
                        if (this.aPanels[n].id == 4) {
                            TweenLite.to(this.aPanels[n], .3, {posX: this.canvasWidth, delay: 2});
                            break
                        }
                    }
                    for (var n = 0; n < this.aPanels.length; n++) {
                    ...
                    break;
                case"push":
                    this.aPanels.push({id: 6, posX: this.canvasWidth / 2 - this.oPanelsImgData.oData.spriteWidth / 2, posY: -160});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], 1, {posY: 213, delay: 1, ease: "Back.easeOut"});
                    this.aPanels.push({id: 9, posX: this.canvasWidth, posY: 385});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], .3, {posX: 383, delay: 2.3});
                    for (var n = 0; n < this.aPanels.length; n++) {
                    ...
                    break;
                case"compPlay":
                    this.aPanels.push({id: 5, posX: this.canvasWidth, posY: 80});
                ...
                case"insuranceLose":
                    ...
                    this.aPanels.push({id: 13, posX: this.canvasWidth / 2 - this.oPanelsImgData.oData.spriteWidth / 2, posY: -160});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], .5, {posY: -20});
                    break;
                case"hidePlayOn":
                    for (var n = 0; n < this.aPanels.length; n++) {
                        if (this.aPanels[n].id == 13) {
                            TweenLite.to(this.aPanels[n], .5, {posY: -160})
                        }
                    }
                    break;
                case"insuranceWin":
                    this.aPanels.push({id: 10, posX: this.canvasWidth / 2 - this.oPanelsImgData.oData.spriteWidth / 2, posY: -160});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], 1, {posY: 213, ease: "Back.easeOut"});
                    this.aPanels.push({id: 9, posX: this.canvasWidth, posY: 385});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], .3, {posX: 383, delay: 1.3});
                    for (var n = 0; n < this.aPanels.length; n++) {
                        if (this.aPanels[n].id == 4) {
                            TweenLite.to(this.aPanels[n], .3, {posX: this.canvasWidth, delay: 1});
                            break
                        }
                    }
                    break;
                case"playerWin":
                    this.aPanels.push({id: 12, posX: this.canvasWidth / 2 - this.oPanelsImgData.oData.spriteWidth / 2, posY: -160});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], 1, {posY: 213, ease: "Back.easeOut"});
                    this.aPanels.push({id: 9, posX: this.canvasWidth, posY: 385});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], .3, {posX: 383, delay: 1.3});
                    for (var n = 0; n < this.aPanels.length; n++) {
                    ...
                    break;
                case"compWin":
                    this.aPanels.push({id: 11, posX: this.canvasWidth / 2 - this.oPanelsImgData.oData.spriteWidth / 2, posY: -160});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], 1, {posY: 213, ease: "Back.easeOut"});
                    this.aPanels.push({id: 9, posX: this.canvasWidth, posY: 385});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], .3, {posX: 383, delay: 1.3});
                    for (var n = 0; n < this.aPanels.length; n++) {
                    ...
                    break;
                case"compBust":
                    this.aPanels.push({id: 2, posX: this.canvasWidth / 2 - this.oPanelsImgData.oData.spriteWidth / 2, posY: -160});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], 1, {posY: 213, ease: "Back.easeOut"});
                    this.aPanels.push({id: 9, posX: this.canvasWidth, posY: 385});
                    TweenLite.to(this.aPanels[this.aPanels.length - 1], .3, {posX: 383, delay: 1.3});
                    for (var n = 0; n < this.aPanels.length; n++) {
                ...
                case"split":
                    ...
                    TweenLite.to(this.playerValuePanel1, .3, {posX: this.canvasWidth});
                    this.aPanels.push({id: 4, posX: -379, posY: 420});
                    this.playerValuePanel2 = this.aPanels[this.aPanels.length - 1];
                    TweenLite.to(this.playerValuePanel2, .3, {posX: -291});
                    this.handSide = "left";
                    break;
                case"switchHands":
                    this.handSide = "right";
                    this.actionCompleteCallback = t.callback;
                    TweenLite.to(this.playerValuePanel1, .3, {posX: 445, delay: .5, onComplete: this.panelSwitchRight, onCompleteParams: [this]});
                    if (t.event == "bust") {
                        TweenLite.to(this.playerValuePanel2, .3, {posX: -379, delay: .5})
                    }
                    break
            }
        };
        ...
        e.prototype.showDealBut = function () {
            ...
            TweenLite.to(this.aPanels[1], .5, {posX: 383})
        };
        e.prototype.hideDealBut = function () {
            TweenLite.killTweensOf(this.aPanels[1]);
            TweenLite.to(this.aPanels[1], .5, {posX: this.canvasWidth})
        };
        e.prototype.render = function (e) {
            this.renderFunc(e)
        };
...
(function (e) {
    var t = function () {
        function e(e, t, n, r, i) {
            ...
            this.canvasWidth = r;
            this.canvasHeight = i;
            this.aChipStacks = new Array({targX: 3, targY: 630, x: 200, y: 800}, {targX: 133, targY: 630, x: 200, y: 800}, {targX: 266, targY: 630, x: 200, y: 800}, {targX: 399, targY: 630, x: 200, y: 800})
        }
        ...
        e.prototype.setUp = function (e) {
            switch (e) {
                case"betting":
                    ...
                    for (var n = 0; n < t; n++) {
                        TweenLite.to(this.aChipStacks[n], .5, {y: this.aChipStacks[n].targY, x: this.aChipStacks[n].targX, ease: "Back.easeOut", delay: n * .1})
                    }
                    break;
                case"firstDeal":
                    ...
                    for (var n = 0; n < Math.min(this.aBetChips.length, 5); n++) {
                        var r = {id: this.aBetChips[this.aBetChips.length - n - 1], posX: 170 + n * n * 3 + 1 * n, posY: 400, scale: 1};
                        this.aSmallBetChips.push(r);
                        TweenLite.killTweensOf(this);
                        TweenLite.to(this.aSmallBetChips[n], .3, {scale: .5, posX: Math.random() * 90 + 190, posY: Math.random() * 10 + 550, delay: n * .1})
                    }
                    for (var n = 0; n < this.aChipStacks.length; n++) {
                        TweenLite.to(this.aChipStacks[n], .3, {y: 800, x: 200, delay: n * .1})
                    }
                    break;
                case"double":
                    ...
                    for (var n = 0; n < this.aSmallBetChips.length; n++) {
                        var r = {id: this.aSmallBetChips[n].id, posX: 200, posY: 800, scale: 1};
                        this.aDoubleBetChips.push(r);
                        TweenLite.to(this.aDoubleBetChips[n], .5, {posX: Math.random() * 90 + 190, posY: Math.random() * 10 + 550, ease: "Back.easeOut", delay: .3 + n * .1})
                    }
                    break
            }
        };
        e.prototype.addChip = function (e, t, n) {
            ...
            TweenLite.killTweensOf(this);
            TweenLite.to(this, .3, {curChipX: 170 + r * r * 3 + 1 * r, curChipY: 400, ease: "Back.easeOut", onComplete: this.betTweenComplete, onCompleteParams: [this]});
        ...
        e.prototype.removeChip = function (e, t) {
            ...
            this.aBetChips.pop();
            TweenLite.killTweensOf(this);
            TweenLite.to(this, .3, {curChipX: this.aChipStacks[this.curChipId].targX, curChipY: this.aChipStacks[this.curChipId].targY, ease: "Back.easeIn", onComplete: this.betTweenComplete, onCompleteParams: [this]});
        ...
        e.prototype.setUp = function (e, t) {
            ...
            switch (e) {
                case"firstDeal":
                    ...
                    this.aCurPlayerCards.push({id: t.aPlayerDealtCards[0].id, posX: 200, posY: -200, rotation: 0});
                    this.aCurPlayerCards.push({id: t.aPlayerDealtCards[1].id, posX: 200, posY: -200, rotation: 0});
                    this.aCompCards.push({id: t.aCompDealtCards[0].id, posX: 200, posY: -200, rotation: 0, scaleX: 1});
                    this.aCompCards.push({id: 52, posX: 200, posY: -200, rotation: 0, scaleX: 1});
                    for (var n = 0; n < this.aCurPlayerCards.length; n++) {
                        var r = this.getCentreX(n, this.aCurPlayerCards.length, this.centreId);
                        TweenLite.to(this.aCurPlayerCards[n], 1, {rotation: this.getRotation(r), posX: this.getCentreX(n, this.aCurPlayerCards.length, this.centreId), posY: 460, delay: n * .1});
                        var r = this.getCentreX(n, this.aCompCards.length, this.centreId);
                        TweenLite.to(this.aCompCards[n], 1, {rotation: this.getRotation(r), posX: this.getCentreX(n, this.aCompCards.length, this.centreId), posY: 130, delay: n * .1 + .2})
                    }
                    break;
                case"newPlayerCard":
                    this.aCurPlayerCards.push({id: t.newCard.id, posX: 200, posY: -200, rotation: 0});
                    for (var n = 0; n < this.aCurPlayerCards.length; n++) {
                        var r = this.getCentreX(n, this.aCurPlayerCards.length, this.centreId);
                        if (t.callback && n == this.aCurPlayerCards.length - 1) {
                            this.actionCompleteCallback = t.callback;
                            TweenLite.to(this.aCurPlayerCards[n], 1, {rotation: this.getRotation(r), posX: r, posY: 460, onComplete: this.handComplete, onCompleteParams: [this]});
                            break
                        }
                        TweenLite.to(this.aCurPlayerCards[n], 1, {rotation: this.getRotation(r), posX: r, posY: 460})
                    }
                    break;
                case"newCompCard":
                    this.centreId = 0;
                    this.aCompCards.push({id: t.oNewCard.id, posX: 200, posY: -200, rotation: 0, scaleX: 1});
                    for (var n = 0; n < this.aCompCards.length; n++) {
                        var r = this.getCentreX(n, this.aCompCards.length, this.centreId);
                        if (t.callback && n == this.aCompCards.length - 1) {
                            this.actionCompleteCallback = t.callback;
                            TweenLite.to(this.aCompCards[n], 1, {rotation: this.getRotation(r), posX: r, posY: 130, onComplete: this.handComplete, onCompleteParams: [this]});
                            break
                        }
                        TweenLite.to(this.aCompCards[n], 1, {rotation: this.getRotation(r), posX: r, posY: 130})
                    }
                    break;
                case"compPlay":
                    this.centreId = 0;
                    TweenLite.to(this.aCompCards[1], .5, {scaleX: 0, ease: "Power1.easeIn"});
                    this.aCompCards.push({id: t.oHoleCard.id, posX: this.aCompCards[1].posX, posY: this.aCompCards[1].posY, rotation: this.aCompCards[1].rotation, scaleX: 0});
                    TweenLite.to(this.aCompCards[2], .5, {scaleX: 1, delay: .5, onComplete: this.holeCardRevealComplete, onCompleteParams: [this]});
                    this.actionCompleteCallback = t.callback;
                    break;
                case"compShow":
                    this.centreId = 0;
                    TweenLite.to(this.aCompCards[1], .5, {scaleX: 0, ease: "Power1.easeIn"});
                    this.aCompCards.push({id: t.oHoleCard.id, posX: this.aCompCards[1].posX, posY: this.aCompCards[1].posY, rotation: this.aCompCards[1].rotation, scaleX: 0});
                    TweenLite.to(this.aCompCards[2], .5, {scaleX: 1, delay: .5});
                    break;
                ...
                case"split":
                    ...
                    TweenLite.to(this.aCurPlayerCards[0], .5, {rotation: this.getRotation(r), posX: r});
                    var r = this.getCentreX(0, this.aPlayerCards2.length, 2);
                    TweenLite.to(this.aPlayerCards2[0], .5, {rotation: this.getRotation(r), posX: r});
                    break;
                case"switchHands":
                    this.centreId = 2;
...
(function (e) {
    var t = function () {
        function e(e, t, n) {
            ...
            this.canvasWidth = t;
            this.canvasHeight = n;
            this.aButs = new Array({targX: 3, targY: 630, x: 200, y: 800, isOn: true}, {targX: 133, targY: 630, x: 200, y: 800, isOn: true}, {targX: 266, targY: 630, x: 200, y: 800, isOn: true}, {targX: 399, targY: 630, x: 200, y: 800, isOn: true})
        }
        ...
        e.prototype.setUp = function (e, t) {
            ...
            switch (e) {
                case"firstDeal":
                    ...
                    for (var n = 0; n < this.aButs.length; n++) {
                        if (this.aButs[n].isOn) {
                            TweenLite.to(this.aButs[n], .5, {y: this.aButs[n].targY, x: this.aButs[n].targX, ease: "Back.easeOut", delay: 1 + n * .1, onComplete: this.allowButs, onCompleteParams: [this]})
                        }
                    }
                    break;
                case"double":
                case"stand":
                    for (var n = 0; n < this.aButs.length; n++) {
                        if (this.aButs[n].isOn) {
                            TweenLite.to(this.aButs[n], .3, {y: 800, x: 200, delay: n * .1})
                        }
                    }
                    break;
                case"split":
                ...
                case"insuranceWin":
                    for (var n = 0; n < this.aButs.length; n++) {
                        if (this.aButs[n].isOn) {
                            TweenLite.to(this.aButs[n], .3, {y: 800, x: 200, delay: 1 + n * .1})
                        }
                    }
                    break
            }
...
if (typeof window.AudioContext !== "undefined" || typeof window.webkitAudioContext !== "undefined" || navigator.userAgent.indexOf("Android") == -1) {
    allowSound = true;
    sound = new Howl({urls: ["source/plugin/tyx_blackjack/template/images/sound.ogg", "source/plugin/tyx_blackjack/template/images/sound.m4a"], sprite: {click: [0, 150], cardHard: [250, 500], chip: [1e3, 300], bust: [1500, 750], win: [2500, 750], blackjack: [3500, 750], push: [4500, 750], cardSoft: [5500, 300], chipIntro: [6e3, 500]}})
}
var panel;
var background;
var bet = 0;
