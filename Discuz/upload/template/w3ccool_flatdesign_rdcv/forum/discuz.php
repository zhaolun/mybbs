<?php echo '<p>/* DISCUZ Document */</p> <p>/*------------------------------------------------------------------</p><p>*Fiename:               discuz.php</p>         <p>*Description:           fiatdesign discuz</p> <p>*Version:               1.0.0(2014-07-12)YYYY-MM-DD</p> <p>*Website:               http://www.subzerolove.com</p> <p>*Copyright:             http://www.w3ccool.com</p> <p>*Assist:                w3ccool</p> <p>*Author:                SubzeroLove</p> <br>==END:=========================================================<p>W3CCOOL商业模板保护！请到官网上购买正版模板  www.w3ccool.com</p> ';exit ;?>
<!--{template common/header}-->
<script type="text/javascript" src="template/w3ccool_flatdesign_rdcv/static/js/jquery-1.9.1.min.js" ignoreapd="1"></script>
<script type="text/javascript" src="template/w3ccool_flatdesign_rdcv/static/js/slides.jquery.js" ignoreapd="1"></script>
<script language="javascript">
	function w3c(area, id) {
...
<div class="w3c_exhibition">
	<div class="w3c_exhibition_l"></div>
	<div class="w3c_exhibition_r">
		<div class="w3c_er">
			<!--[diy=w3c_er]-->
			<div id="w3c_er" class="area"></div><!--[/diy]-->
			<div id="index" class="cl">
				<div id="i1" class="tabcontent" style="">
					<!--[diy=w3c_i1]-->
					<div id="w3c_i1" class="area"></div><!--[/diy]-->
				</div>
				<div id="i2" class="tabcontent" style="display: none;">
					<!--[diy=w3c_i2]-->
					<div id="w3c_i2" class="area"></div><!--[/diy]-->
				</div>
				<div id="i3" class="tabcontent" style="display: none;">
					<!--[diy=w3c_i3]-->
					<div id="w3c_i3" class="area"></div><!--[/diy]-->
				</div>
				<ul class="w3c_index_tab cl" id="indextabs">
					<li id="i1tab" class="tab curtab">
						<a href="javascript:" onmousemove="w3c('index','i1')">
							新<br>贴
						</a>
					</li>
					<li id="i2tab" class="tab">
						<a href="javascript:" onmouseover="w3c('index','i2')">
							热<br>门
						</a>
					</li>
					<li id="i3tab" class="tab">
						<a href="javascript:" onmouseover="w3c('index','i3')">
							推<br>荐
						</a>
					</li>
				</ul>
		...
		<div class="w3c_el">
			<div id="indexslider">
				<!--[diy=w3c_el]-->
				<div id="w3c_el" class="area"></div><!--[/diy]-->
			</div>
		</div>
	</div>
</div>
{if $announcements || !empty($gid)}
...
<div id="ct" class="wp cl{if $_G['setting']['forumallowside']} ct2{/if}">
	...
	<div id="chart" class="bm bw0 cl">
		<p class="chart z">
			{lang index_today}: <em>$todayposts</em><span class="pipe">|</span>{lang index_yesterday}: <em>$postdata[0]</em><span class="pipe">|</span>{lang index_posts}: <em>$posts</em><span class="pipe">|</span>{lang index_members}: <em>$_G['cache']['userstats']['totalmembers']</em><!--{if $_G['cache']['userstats']['newsetuser']}--><span class="pipe">|</span>{lang welcome_new_members}: <em>
			<a href="home.php?mod=space&username={echo rawurlencode($_G['cache']['userstats']['newsetuser'])}" target="_blank" class="xi2">
		...
		<div class="y">
			...
			<!--{if $_G['uid']}-->
			<a href="forum.php?mod=guide&view=my" title="{lang my_posts}" class="xi2">
				{lang my_posts}
			</a><!--{/if}--><!--{if !empty($_G['setting']['search']['forum']['status'])}--><!--{if $_G['uid']}--><span class="pipe">|</span><!--{/if}-->
			<a href="forum.php?mod=guide&view=new" title="{lang show_newthreads}" class="xi2">
	...
	<!--{/if}-->
	<!--[diy=diy_chart]-->
	<div id="diy_chart" class="area"></div><!--[/diy]-->
	<div class="mn">
		<!--{if !empty($_G['setting']['grid']['showgrid'])}-->
		<!-- index four grid -->
		<div class="w3c_fbox bm">
			<div class="bm bmw cl">
...
<!--{/loop}-->
							...
							<div class="replaybox">
								...
								<ul class="category_newlist">
									...
									<!--{/if}-->
									<li>
										<a href="forum.php?mod=redirect&tid=$thread[tid]&goto=lastpost#lastpost"{if $thread['highlight']} $thread['highlight']{/if}{if $_G['setting']['grid']['showtips']}tip="{lang title}: <strong>$thread[oldsubject]</strong><br/>{lang author}: $thread[author] ($thread[dateline])<br/>{lang show}/{lang reply}: $thread[views]/$thread[replies]" onmouseover="showTip(this)"{else} title="$thread[oldsubject]"{/if}{if $_G['setting']['grid']['targetblank']} target="_blank"{/if}>
											$thread[subject]
										</a>
									</li>
									<!--{/loop}-->
			...
			<div class="bm_c cl">
				<div class="heat z">
					...
					<dl class="xld">
						<dt>
							<!--{if $_G['adminid'] == 1}-->
							<a class="d" href="forum.php?mod=misc&action=removeindexheats&tid=$data[tid]" onclick="return removeindexheats()">
								delete
							</a><!--{/if}-->
							<a href="forum.php?mod=viewthread&tid=$data[tid]" target="_blank" class="xi2">
								$data[subject]
							</a>
						</dt>
						<dd>
		...
		<div class="w3c_fbox bm">
			...
			<div class="w3c_fbox_bm bmw {if $forumcolumns} flg{/if} cl">
				<div class="bm_h cl">
					<span class="o">
					...
					<h2>
					<a href="forum.php?mod=collection&op=my">
						{lang my_order_collection}
					</a></h2>
				</div>
				<div id="category_-1" class="bm_c" style="{echo $collapse['category_-1']}">
					<table cellspacing="0" cellpadding="0" class="fl_tb">
						...
						<tr class="fl_row">
							...
							<div class="fl_icn_g">
								<a href="forum.php?mod=collection&action=view&ctid={$colletion[ctid]}" target="_blank">
									<img src="{IMGDIR}/forum{if $followcollections[$key]['lastvisit'] < $colletion['lastupdate']}_new{/if}.gif" alt="$colletion[name]" />
								</a>
							</div>
							<dl>
								<dt>
									<a href="forum.php?mod=collection&action=view&ctid={$colletion[ctid]}">
										$colletion[name]
									</a>
								</dt>
								<dd>
									<em>{lang forum_threads}: <!--{echo dnumber($colletion[threadnum])}--></em>, <em>{lang collection_commentnum}: <!--{echo dnumber($colletion[commentnum])}--></em>
								</dd>
								<dd>
									...
									<cite><!--{date($colletion[lastposttime])}--> <!--{if $colletion['lastposter']}-->$colletion['lastposter']<!--{else}-->$_G[setting][anonymoustext]<!--{/if}--></cite>
									<!--{else}-->
									<a href="forum.php?mod=redirect&tid=$colletion[lastpost]&goto=lastpost#lastpost">
										{lang forum_lastpost}: <!--{date($colletion[lastposttime])}-->
									</a>
									<!--{/if}-->
									<!--{else}-->
									{lang never}
			...
			<div class="w3c_fbox_bm bmw {if $forumcolumns} flg{/if} cl">
				<div class="bm_h cl">
					...
					<h2>
					<a href="home.php?mod=space&do=favorite&type=forum">
						{lang forum_myfav}
					</a></h2>
				</div>
				<div id="category_0" class="bm_c" style="{echo $collapse['category_0']}">
					<table cellspacing="0" cellpadding="0" class="fl_tb">
						...
						<tr class="fl_row">
							...
							<dl{if !empty($forum[extra][iconwidth]) && !empty($forum[icon])} style="margin-left: {$forum[extra][iconwidth]}px;"{/if}>
								<dt>
									<a href="$forumurl"{if $forum[redirect]} target="_blank"{/if}{if $forum[extra][namecolor]} style="color: {$forum[extra][namecolor]};"{/if}>
										$forum[name]
									</a><!--{if $forum[todayposts] && !$forum['redirect']}--><em class="xw0 xi1" title="{lang forum_todayposts}"> ($forum[todayposts])</em><!--{/if}-->
								</dt>
							...
							<!--{eval $favorderid++;}-->
							<!--{else}-->
							<td class="fl_icn" {if !empty($forum[extra][iconwidth]) && !empty($forum[icon])} style="width: {$forum[extra][iconwidth]}px;"{/if}><!--{if $forum[icon]}--> $forum[icon] <!--{else}-->
							<a href="$forumurl"{if $forum[redirect]} target="_blank"{/if}>
								<img src="{IMGDIR}/forum{if $forum[folder]}_new{/if}.gif" alt="$forum[name]" />
							</a><!--{/if}--></td>
							<td><h2>
							<a href="$forumurl"{if $forum[redirect]} target="_blank"{/if}{if $forum[extra][namecolor]} style="color: {$forum[extra][namecolor]};"{/if}>
								$forum[name]
							</a><!--{if $forum[todayposts] && !$forum['redirect']}--><em class="xw0 xi1" title="{lang forum_todayposts}"> ($forum[todayposts])</em><!--{/if}--></h2><!--{if $forum[description]}-->
							<p class="xg2">
								$forum[description]
							</p><!--{/if}--><!--{if $forum['subforums']}-->
							<p>
								{lang forum_subforums}: $forum['subforums']
							</p><!--{/if}--><!--{if $forum['moderators']}-->
							<p>
								{lang forum_moderators}: <span class="xi2">$forum[moderators]</span>
							</p><!--{/if}--><!--{hook/index_favforum_extra $forum[fid]}--></td>
			...
			<div class="w3c_fbox_bm bmw {if $cat['forumcolumns']} flg{/if} cl">
				<div class="bm_h cl">
					<span class="o">
					...
					<h2>
					<a href="{if !empty($caturl)}$caturl{else}forum.php?gid=$cat[fid]{/if}" style="{if $cat[extra][namecolor]}color: {$cat[extra][namecolor]};{/if}">
						$cat[name]
					</a></h2>
				</div>
				<div id="category_$cat[fid]" class="bm_c" style="{echo $collapse['category_'.$cat[fid]]}">
					<table cellspacing="0" cellpadding="0" class="fl_tb">
						...
						<tr class="fl_row">
							...
							<p>
								{lang forum_moderators}: <span class="xi2">$forum[moderators]</span>
							</p><!--{/if}--><!--{hook/index_forum_extra $forum[fid]}--></td>
							<td class="fl_i"><!--{if empty($forum[redirect])}--><span class="xi2"><!--{echo dnumber($forum[threads])}--></span><span class="xg1"> / <!--{echo dnumber($forum[posts])}--></span><!--{/if}--></td>
							<td class="fl_by">
							<div>
								<!--{if $forum['permission'] == 1}-->
			...
			<div class="bm bmw {if $forumcolumns} flg{/if} cl">
				<div class="bm_h cl">
					...
					<h2>
					<a href="forum.php?mod=collection">
						{lang recommend_collection}
					</a></h2>
				</div>
				<div id="category_-2" class="bm_c" style="{echo $collapse['category_-2']}">
					<table cellspacing="0" cellpadding="0" class="fl_tb">
						...
						<tr class="fl_row">
							...
							<div class="fl_icn_g">
								<a href="forum.php?mod=collection&action=view&ctid={$colletion[ctid]}" target="_blank">
									<img src="{IMGDIR}/forum.gif" alt="$colletion[name]" />
								</a>
							</div>
							<dl>
								<dt>
		...
		<div id="online" class="w3c_fbox_bm oll">
			<div class="bm_h">
				<!--{if $detailstatus}-->
				<span class="o">
					<a href="forum.php?showoldetails=no#online" title="{lang spread}">
						<img src="{IMGDIR}/collapsed_no.gif" alt="{lang spread}" />
					</a></span>
				<h3><strong>
				<a href="home.php?mod=space&do=friend&view=online&type=member">
					{lang onlinemember}
				</a></strong><span class="xs1">- <strong>$onlinenum</strong> {lang onlines}
				...
				<span class="o">
					<a href="forum.php?showoldetails=yes#online" title="{lang spread}">
						<img src="{IMGDIR}/collapsed_yes.gif" alt="{lang spread}" />
					</a></span>
				<!--{/if}-->
				<h3><strong> <!--{if !empty($_G['setting']['whosonlinestatus'])}--> {lang onlinemember} <!--{else}-->
				<a href="home.php?mod=space&do=friend&view=online&type=member">
					{lang onlinemember}
				</a> <!--{/if}--> </strong><span class="xs1">- {lang total} <strong>$onlinenum</strong> {lang onlines} <!--{if $membercount}-->- <strong>$membercount</strong> {lang index_members},<strong>$guestcount</strong> {lang index_guests}<!--{/if}--> - {lang index_mostonlines} <strong>$onlineinfo[0]</strong> {lang on} <strong>$onlineinfo[1]</strong>.</span></h3>
				<!--{/if}-->
			</div>
				...
				<dd class="ptm pbm">
					<ul class="cl">
						...
						<li title="{lang time}: $online[lastactivity]">
							...
							<!--{if $online['uid']}-->
							<a href="home.php?mod=space&uid=$online[uid]">
								$online[username]
							</a>
							<!--{else}-->
							$online[username]
