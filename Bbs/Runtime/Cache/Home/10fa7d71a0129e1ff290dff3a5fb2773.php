...
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>积分商城 -  传智论坛-IT学习社区 -  Powered by Discuz!</title>
...
<meta name="MSSmartTagsPreventParsing" content="True" />
<meta http-equiv="MSThemeCompatible" content="Yes" />
<base href="http://bbs.itcast.cn/" /><link rel="stylesheet" type="text/css" href="data/cache/style_8_common.css?cg8" /><script type="text/javascript">var STYLEID = '8', STATICURL = 'static/', IMGDIR = 'static/image/common', VERHASH = 'cg8', charset = 'utf-8', discuz_uid = '0', cookiepre = 'UwrY_2132_', cookiedomain = '', cookiepath = '/', showusercard = '1', attackevasive = '0', disallowfloat = 'sendpm|newthread|nav', creditnotice = '1|金钱|,2|经验|,3|金币|,4|宣传贡献|,5|冻结金币|', defaultstyle = '', REPORTURL = 'aHR0cDovL2Jicy5pdGNhc3QuY24vcGx1Z2luLnBocD9pZD1hdWN0aW9u', SITEURL = 'http://bbs.itcast.cn/', JSPATH = 'static/js/', CSSPATH = 'data/cache/style_', DYNAMICURL = '';</script>
<script src="static/js/common.js?cg8" type="text/javascript"></script>
<meta name="application-name" content="传智论坛-IT学习社区" />
<meta name="msapplication-tooltip" content="传智论坛-IT学习社区" />
<meta name="msapplication-task" content="name=IT学习社区;action-uri=http://bbs.itcast.cn/portal.php;icon-uri=http://bbs.itcast.cn/static/image/common/portal.ico" />
...
<body id="nv_plugin" class="pg_auction" onkeydown="if(event.keyCode==27) return false;">
...
<div class="fastlg_fm y" style="margin-right: 10px; padding-right: 10px">
<p><a href="http://bbs.itcast.cn/connect.php?mod=login&op=init&referer=plugin.php%3Fid%3Dauction&statfrom=login_simple"><img src="static/image/common/qq_login.gif" class="vm" alt="QQ登录" /></a></p>
<p class="hm xg1" style="padding-top: 2px;">只需一步，快速开始</p>
</div>
...
<input type="hidden" name="srchtype" value="title" />
<input type="hidden" name="srhfid" value="0" />
<input type="hidden" name="srhlocality" value="plugin::auction" />
<input type="hidden" name="sId" value="9241304" />
<input type="hidden" name="ts" value="1419230594" />
<input type="hidden" name="cuId" value="0" />
<input type="hidden" name="cuName" value="" />
<input type="hidden" name="gId" value="7" />
<input type="hidden" name="agId" value="0" />
...
<input type="hidden" name="ugSign7" value="" />
<input type="hidden" name="ext_vgIds" value="0" />
<input type="hidden" name="sign" value="752a055193ef6f2d214ef4de42623ca7" />
<input type="hidden" name="charset" value="utf-8" />
<input type="hidden" name="source" value="discuz" />
<input type="hidden" name="fId" id="srchFId" value="0" />
<input type="hidden" name="q" id="cloudsearchquery" value="" />
...
initSearchmenu('scbar', 'http://search.itcast.cn/f/discuz');
  ...
  <div id="nv">
    <ul>
            ...
            <li class="a" id="mn_Ne30e" ><a href="plugin.php?id=auction" hidefocus="true" title="金币积分兑换礼品" target="_blank"  >积分商城<span>金币积分兑换礼品</span></a></li>
...
<div id="wp" class="wp">
>>>>>>> 85338da02e9fa0d364a5d0d9c4711bf3d2a655d9
...
<input type="hidden" value="f07d323e" name="formhash" />
</form>
<script type="text/javascript">
...
<<<<<<< HEAD
<?php if(is_array($info)): foreach($info as $key=>$it): ?><div class="aucdd">
<p class="a_n"><a href="http://www.mybbs.com/bbs.php/Home/Plugin/plugin_xq?id=<?php echo ($it["id"]); ?>" target="_blank"><?php echo ($it["s_name"]); ?></a></p>
<input type="hidden" id="35590" value="1418089140"/><div class="pic" style="height:146px;"><div class="number" title="先到先得">先到先得</div><a href="http://www.mybbs.com/bbs.php/Home/Plugin/plugin_xq?id=<?php echo ($it["id"]); ?>" title=""><img src="forum.php?mod=image&aid=54483&size=140x140&key=c95b1808929c9c99"></a></div>
<div class="pic">
<p id="time_35590" class="timeline a_ct">已经结束</p>
<p class="a_lt"><span>市场价：</span><del><?php echo ($it["s_price"]); ?></del></p>
<p class="a_lt"><span>兑&nbsp;&nbsp;&nbsp;换：</span><em><?php echo ($it["price"]); ?></em> 金币</p>
<p class="a_ct" id="vd_35590"><a href="http://www.mybbs.com/bbs.php/Home/Plugin/plugin_xq?id=<?php echo ($it["id"]); ?>" target="_blank" style="background-image:url(source/plugin/auction/images/auction1.png);">查看详情&rsaquo;&rsaquo;</a></p>
</div>
...
<p class="xs0">
GMT+8, 2014-12-22 14:43<span id="debuginfo">
</span>
</p>
</div>
<div id="frt">
...
<script src="home.php?mod=misc&ac=sendmail&rand=1419230594" type="text/javascript"></script> 
...
<script type="text/javascript">_attachEvent(window, 'scroll', function () { showTopLink(); });checkBlind();</script> 
			...
			<script type="text/javascript">
				var tipsinfo = '9241304|X3.2|0.6||0||0|7|1419230594|4a8a36c2b5405ab4e3ddabd4cec325db|2';
			</script>
