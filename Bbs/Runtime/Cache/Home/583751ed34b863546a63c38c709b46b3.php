...
<a href="./" class="nvhm" title="首页">传智论坛-IT学习社区</a><em>&raquo;</em><a href="forum.php" id="fjump" onmouseover="delayShow(this, 'showForummenu(177)');" class="showmenu">技术论坛</a><em>&rsaquo;</em> 免费课程</div>
<div class="z">
...
<div id="category_177" class="bm_c" style=""><?php if(is_array($list)): foreach($list as $key=>$vo): ?><table cellspacing="0" cellpadding="0" class="fl_tb">
<tr><td class="fl_icn" >
<a href="forum-178-1.html"><img src="static/image/common/forum_new.gif" alt="免费公开课" /></a>
</td>
<td>
<h2><a href="http://www.mybbs.com/bbs.php/home/forum/huifu/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a><em class="xw0 xi1" title="今日"> (24)</em></h2>
</td>
<td class="fl_i">
                            
<span class="xi2">229</span><span class="xg1"> / <span title="47196">4万</span></span>
                            </td>
