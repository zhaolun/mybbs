...
<div></div>
	...
	<dt class="fl">
		<a href="http://www.mybbs.com/index.php/Home/index/banji?id=<?php echo ($infob["0"]["id"]); ?>" target="_blank"><img src="/public/images/6.jpg" style="width: 286px; height: 215px;" /><br />
		<?php echo ($infob["0"]["title"]); ?></a></dt>
	<dd class="huodongfr">
		<h3 class="STYLE7">班级活动</h3>
		<ul class="bjhd">
		<?php if(is_array($infob)): foreach($infob as $key=>$it): ?><li><img src="http://php.itcast.cn/images/great.jpg" /><a href="http://www.mybbs.com/index.php/Home/index/banji?id=<?php echo ($it["id"]); ?>" target="_blank"><?php echo ($it["title"]); ?></a></li><?php endforeach; endif; ?>
		</ul>
	</dd>
</dl>

				<div class="clear"></div>
                <p class="text-r"><a href="#"><img src="/Public/images/jiantoumore.gif"/></a></p>
			  </div>
	...
	<div class="f_right">
		...
		<div class="fr_c4">
			<ul>
				...
				<li class="fr_c4_li2"><div id="nobold" style="font-family:Arial;">15010390391</div></li>
			</ul>
		</div>
		<div class="fr_c6">
			<ul>
