...
<div id="box">
	<div id="left" class="fl">
		...
		<div class="left_content">
			<h2 class="title1"><span class="STYLE3">企业招聘</span></h2>
			<ul class="com_links">
			<?php if(is_array($info)): foreach($info as $key=>$vo): ?><li><a href="/index.php/Home/index/company/id/<?php echo ($vo["id"]); ?>" target="_blank"><?php echo ($vo["company"]); ?></a>  　　<?php echo (substr($vo["time"],0,10)); ?></li><?php endforeach; endif; ?>
			</ul>
			<div class="clear"></div>
			<div class="pages"></div>
