...
<a href='' style='font-size:20px'>用户名：</a><input type="text" name="username" style='width:150px height:20px'><br>
<a href='' style='font-size:20px'>密码：</a><input type="password" name="password"><br>
