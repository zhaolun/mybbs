...
<div id="box">
	<div id="left" class="fl">
		...
		<h2 class="title1"><span class="STYLE3">PHP名师答疑</span></h2>
		<div class="picnews"></div>
			<ul class="com_links">
			<?php if(is_array($info)): foreach($info as $key=>$vo): ?><li><a href="/index.php/home/index/detail/id/<?php echo ($vo["id"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a>　　  <?php echo (substr($vo["time"],0,10)); ?></li><?php endforeach; endif; ?>
			</ul>
		<div class="clear"></div>
		<div class="pages"></div>
<div class="clear"></div>
