...
<body>
<h1>
<span class="action-span1">活动列表</span><span id="search_id" class="action-span1"></span>
...
<table cellspacing='1' cellpadding='3'>
  <tr>
	...
	<th  class="group-title">活动名称</th>
	<th  class="group-title">活动介绍</th>
  ...
  <?php if(is_array($info)): foreach($info as $key=>$vo): ?><tr class="table_tr">
	...
	<td width="35%"><a href='/admin.php/home/banji/del?id=<?php echo ($vo["id"]); ?>'>删除</a>|<a href='/admin.php/home/banji/bian?id=<?php echo ($vo["id"]); ?>'>编辑</a></td>
