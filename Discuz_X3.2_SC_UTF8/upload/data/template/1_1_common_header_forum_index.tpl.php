...
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1419824623, '1', './data/template/1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1419824623, '1', './data/template/1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
=======
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1419833038, '1', './data/template/1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1419833038, '1', './data/template/1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1419833038, '1', './data/template/1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
>>>>>>> 290b077fa88a13c62418c403b6211f2ca7afb0ff:Discuz_X3.2_SC_UTF8/upload/data/template/1_1_common_header_forum_index.tpl.php
;?>
...
<div class="wp">
<div class="hdc cl"><?php $mnid = getcurrentnav();?><h2><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>">

<!--首页logo-->

<img src="http://bbs.itcast.cn/template/veikei_dz_portal_20131130_texture/images/logo.png"></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?><a href="plugin.php?id=wechat:login"><img src="http://www.mybbs.com/Discuz/upload/source/plugin/wechat/image/wechat_login.png"></a></h2><?php include template('common/header_userstatus'); ?></div>
